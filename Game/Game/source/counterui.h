...
namespace counter
{
	static constexpr auto COUNTER_TREASURE_X = 255;//1809.0f
	static constexpr auto COUNTER_TREASURE_Y = 90;//100.0f
	static constexpr auto COUNTER_MAKIMONO_X = 175;
	static constexpr auto COUNTER_MAKIMONO_Y = 70;
